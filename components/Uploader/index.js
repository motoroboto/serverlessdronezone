...
const Uploader = () => {
	...
	const onSubmit = (vidUpload) => {
		...
		if (file) {
			const s3Bucket =
				"https://rckeeluploadvideobuckettest1113114-dev.s3.amazonaws.com/";
	...
	return (
		<Grid item style={{ width: "400px", marginTop: "30px" }}>
			<AmplifyAuthenticator>
				<AmplifySignIn headerText="Please Login" slot="sign-in" />
				<AmplifySignUp
				...
				<Grid className="video-uploader" mb={2}>
